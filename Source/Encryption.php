...
namespace Source
{
    class Encryption
    {
        private $encryptionKey_password = 'e3f080b6edfcf6fff70654021c7c2e43';
        private $encryptionKey_userKey = 'e1ff2fb6edfcf68ff70654001c1c2e82';
        ...
        {
            $result = Encryption::encrypt($pass, $encryptionKey_password);
            return $result;
        }
        
        public static function decryptPassword($pass)
        {
            $result =  self::decrypt($pass, $encryptionKey_password);   
            return $result;
        }
        
        public static function encryptUserKey($userKey)
        {
            $result = Encryption::encrypt($userKey, $encryptionKey_userKey);
            return $result;
        }
        
        public static function decryptUserKey($userKey)
        {
            $result =  self::decrypt($userKey, $encryptionKey_userKey);   
            return $result;
        }
